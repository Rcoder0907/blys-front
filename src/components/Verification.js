...
function Verification() {
    ...
    const submitCode = async ()=> {
        ...
        const code = [digit1,digit2,digit3,digit4,digit5,digit6].filter(d=>d!==null).join('');
        console.log(code)

        

        try {
          const response = await axios.post(`${Config.url}/verify`, {code});
